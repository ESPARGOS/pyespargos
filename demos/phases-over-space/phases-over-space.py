...
class EspargosDemoPhasesOverSpace(ESPARGOSApplication):
	...
	def __init__(self, argv):
		...
		parser = argparse.ArgumentParser(description = "ESPARGOS Demo: Show phases over space (single board)", add_help = False)
		parser.add_argument("--no-calib", default = False, help = "Disable phase calibration", action = "store_true")
		...
		self.initialize_qml(pathlib.Path(__file__).resolve().parent / "phases-over-space-ui.qml", {
