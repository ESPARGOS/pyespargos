...
class q_image_app(QtWidgets.QApplication):
    ...
    def __init__(self, argv):
        ...
        parser.add_argument("-l", "--lltf", default=False, help="Use only L-LTF CSI", action="store_true")
        ...
        self.backlog = espargos.CSIBacklog(self.pool, size = self.args.backlog, enable_ht40= not self.args.lltf)
        self.backlog.start()
