...
class EspargosDemoPhasesOverTime(ESPARGOSApplication):
	...
	def __init__(self, argv):
		...
		parser = argparse.ArgumentParser(description = "ESPARGOS Demo: Show phases over time (single board)", add_help = False)
		...
		self.initialize_qml(pathlib.Path(__file__).resolve().parent / "phases-over-time-ui.qml", {
