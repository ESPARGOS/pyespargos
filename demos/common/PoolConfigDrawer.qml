	...
	ScrollView {
		...
		GridLayout {
			...
			Switch {
				...
				property string configKey: "per_board_calibration"
			...
			Switch {
				id: showCalibSwitch
				property string configKey: "show_calibration"
				property string configProp: "checked"
				property var encode: function(v) { return v ? 1 : 0 }
				property var decode: function(v) { return !!v }
				Component.onCompleted: poolConfigManager.register(this)
			...
			Switch {
				id: rxGainSwitch
				property string configKey: "automatic_rx_gain"
				property string configProp: "checked"
				property var encode: function(v) { return v ? 1 : 0 }
				property var decode: function(v) { return !!v }
				Component.onCompleted: poolConfigManager.register(this)
			...
			RowLayout {
				...
				Slider {
					id: lnaGainSlider
					property string configKey: "rx_gain"
			...
			Switch {
				id: fftGainSwitch
				property string configKey: "automatic_fft_gain"
				property string configProp: "checked"
				property var encode: function(v) { return v ? 1 : 0 }
				property var decode: function(v) { return !!v }
				Component.onCompleted: poolConfigManager.register(this)
			...
			RowLayout {
				...
				Slider {
					id: fftGainSlider
					property string configKey: "fft_gain"
					property string configProp: "value"
					property var encode: function(v) { return Math.round(v) }
					property var decode: function(v) { return Math.max(0, Math.min(64, parseInt(v||32))) }
					Component.onCompleted: poolConfigManager.register(this)
			...
			Switch {
				id: macFilterSwitch
				property string configKey: "mac_filter_enable"
				property string configProp: "checked"
				property var encode: function(v) { return v ? 1 : 0 }
				property var decode: function(v) { return !!v }
				Component.onCompleted: poolConfigManager.register(this)
			...
			TextField {
				id: macAddrInput
				property string configKey: "mac_address"
