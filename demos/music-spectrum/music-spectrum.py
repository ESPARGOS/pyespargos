...
class EspargosDemoMusicSpectrum(ESPARGOSApplication):
	...
	def __init__(self, argv):
		...
		parser = argparse.ArgumentParser(description = "ESPARGOS Demo: Show MUSIC angle of arrival spectrum (single board)", add_help = False)
		...
		self.initialize_qml(pathlib.Path(__file__).resolve().parent / "music-spectrum-ui.qml", {
